...
do
	tput civis
	echo -ne "\033[34m\r[*] جاري التحميل.........\e[33m[\033[32m$i\033[33m]\033[0m   ";
	sleep $delay
...
echo "";
echo -e "\e[1;34m[*] \e[32mجاري اتثبيت....\e[0m";
echo "";
...
wget https://github.com/malhamhack/TERMUX-LOGORemo773.flf &> /dev/null;
sleep 3
...
\033[0m";
	echo ""
	echo -e "\e[1;34m \033[32mاضغط انتر...\033[0m"
	echo ""
else
	ok=1
fi
...
clear;
echo -e "\033[31m$( "MALHAM")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
MALHAM : (\e[33m14.4.2021\e[32m)
